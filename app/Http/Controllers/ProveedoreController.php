...
class ProveedoreController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.proveedore.create', compact('proveedore'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.proveedore.show', compact('proveedore'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.proveedore.edit', compact('proveedore'));
    }
